...
class TestTypeRBasic(unittest.TestCase):
    ...
    def test_add(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/001-add.hex'
        )
    ...
    def test_sub(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/002-sub.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_and(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/003-and.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_or(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/004-or.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_xor(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/005-xor.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_slt(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/007-slt.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_sltu(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/008-sltu.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_sll(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/006-sll.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_srl(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/009-srl.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
    ...
    def test_sra(self):
        dados, size = read_file(
            '/eda/processor-ci-tests/tests/memory/010-sra.hex'
        )
        self.controller.write_from_accumulator(size, dados)
        self.controller.execute_until_stop()
        retorno = self.controller.read_memory(60)
